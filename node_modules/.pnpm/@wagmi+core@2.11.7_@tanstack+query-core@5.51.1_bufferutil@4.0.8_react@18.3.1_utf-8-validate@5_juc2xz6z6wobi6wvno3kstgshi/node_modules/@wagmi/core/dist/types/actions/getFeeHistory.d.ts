...
export type GetFeeHistoryParameters<config extends Config = Config, chainId extends config['chains'][number]['id'] = config['chains'][number]['id']> = Evaluate<viem_GetFeeHistoryParameters & ChainIdParameter<config, chainId>>;
