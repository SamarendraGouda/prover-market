...
export type EstimateMaxPriorityFeePerGasOptions<config extends Config> = Evaluate<ExactPartial<EstimateMaxPriorityFeePerGasParameters<config>> & ScopeKeyParameter>;
