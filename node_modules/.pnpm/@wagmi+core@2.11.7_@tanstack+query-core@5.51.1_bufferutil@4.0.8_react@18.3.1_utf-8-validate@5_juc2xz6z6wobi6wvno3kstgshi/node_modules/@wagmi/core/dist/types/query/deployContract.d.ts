...
export type DeployContractMutate<config extends Config, context = unknown> = <abi extends Abi | readonly unknown[], chainId extends config['chains'][number]['id']>(variables: DeployContractVariables<abi, config, chainId>, options?: Evaluate<MutateOptions<DeployContractData, DeployContractErrorType, Evaluate<DeployContractVariables<abi, config, chainId>>, context>> | undefined) => void;
export type DeployContractMutateAsync<config extends Config, context = unknown> = <abi extends Abi | readonly unknown[], chainId extends config['chains'][number]['id']>(variables: DeployContractVariables<abi, config, chainId>, options?: Evaluate<MutateOptions<DeployContractData, DeployContractErrorType, Evaluate<DeployContractVariables<abi, config, chainId>>, context>> | undefined) => Promise<DeployContractData>;
