...
export type GetTransactionReceiptOptions<config extends Config, chainId extends config['chains'][number]['id']> = Evaluate<ExactPartial<GetTransactionReceiptParameters<config, chainId>> & ScopeKeyParameter>;
